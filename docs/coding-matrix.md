...
8×A100의 "단일 대형 모델" 픽인 Qwen3.5-397B-A17B는 자사 보고 코딩 성적이 Qwen3.6-27B와 사실상 같습니다(SWE-bench Verified 76.4 대 77.2, [비교표](model-options.md#qwen36-27b와-벤치마크-비교)). 코딩 정확도만 목표라면 27B replica 여러 개가 대안이고, 397B는 지식 폭과 긴 context KV 여유가 목적일 때 선택합니다.
