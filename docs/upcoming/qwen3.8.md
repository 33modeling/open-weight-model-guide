...
| 모델 | 정밀도 | 추정 가중치 | 적재 가능 구성 (추정) |
|---|---|---:|---|
| Qwen3.8 2.4T | 4bit | 약 1.2TB | 16×H100 1.28TB **경계 미달 가능성**(runtime 공간 부족) · 8×MI300X 1.54TB △(FP4 경로 확인) · 8×B300 ◎ |
| Qwen3.8 2.4T | FP8 | 약 2.4TB | 8×B300 2.30TB 경계 미달 — 16×H200/멀티노드 |
| Qwen3.8-27B (가정: 3.6-27B 유사) | FP8 | 약 31GB | 3.6-27B와 동일 취급 — 1×H100/24GB급 양자화 |
